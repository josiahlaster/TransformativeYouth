...
import shape from '/public/images/shapes/portfolio-shape-2.svg'
                            ...
                            <div className={`portfolioBlock portfolioBlock--style2 position-relative ${activeIndex === index ? "portfolioBlock--active" : ""}`}
                                ...
                                <figure className="portfolioBlock__figure">
                                    ...
                                    <div className="portfolioBlock__figure__shape">
                                        <Image src={shape} alt="" />
                                        <Link onClick={ClickHandler} href={'/story-details/[slug]'} as={`/story-details/${stories.slug}`} className="portfolioBlock__more">
                                ...
                                <div className="portfolioBlock__content">
                                    <Link onClick={ClickHandler} href='/donation-listing' className="portfolioBlock__hashLink mb-10"><span>#
                                        Donation</span></Link>
